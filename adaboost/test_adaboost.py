...
# classifier_arr, agg_est = ada.adaboost_train_ds(data_arr, label_arr, 100)
#
...
data_arr, label_arr = load_data.load_data_set('horseColicTraining2.txt')
classifier_arr, agg_est = ada.adaboost_train_ds(data_arr, label_arr, 40)
ada.plot_roc(agg_est.T, label_arr)